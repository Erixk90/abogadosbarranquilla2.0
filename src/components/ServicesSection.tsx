import { Building, Users, FileText, Home, Briefcase, Shield } from 'lucide-react';
...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      icon: FileText,
      title: 'Derecho Civil',
      description: 'Contratos, responsabilidad civil, daños y perjuicios, y litigios civiles en general.'
    },
    {
      icon: Home,
